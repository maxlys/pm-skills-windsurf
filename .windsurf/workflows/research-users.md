# Workflow: research-users

> Comprehensive user research — build personas, segment users, and map the customer journey from research data
**Input:** <research data, survey results, or product description>
